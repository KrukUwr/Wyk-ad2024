...
points(x[tst], y[tst], pch=15, col="green")
...
lines(1:20, tstMSE, lty=2, lwd=3, col="green")
legend("topright", legend=c("Trn. MSE", "Tst. MSE"), 
  lty=c(1, 2), lwd=c(2, 3), col=c("darkred", "green"), pch=c("o", ""))
...
lines(1:20, tstVar, type="b", col="green")
